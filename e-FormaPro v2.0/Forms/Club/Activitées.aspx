<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/Club/Site1.Master" AutoEventWireup="true"
    CodeBehind="~/Forms/Club/Activitées.aspx.cs" Inherits="Projet.Activitées" %>
...
<asp:Content ID="BContentActivitées" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:ImageButton ID="ImageButton2" runat="server" 
            ImageUrl="~/Forms/Formateur/Icon_club/chevron_left_48px.png" />
    </td>
   <td>
    ...
    <asp:ImageButton ID="ImageButton1" runat="server" 
            ImageUrl="~/Forms/Formateur/Icon_club/chevron_right_48px.png" onclick="ImageButton1_Click" />
    </td>
    </tr>
    </table>
</asp:Content>
